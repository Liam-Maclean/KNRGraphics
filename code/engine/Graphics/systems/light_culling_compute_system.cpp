#include <qlpch.h>
#include "light_culling_compute_system.h"
...
namespace QRender
{
	...
	LightCullingComputeSystem::LightCullingComputeSystem(RenderSystemManager& manager)
		: RenderSystem(manager)
	{

	}
	LightCullingComputeSystem::~LightCullingComputeSystem()
	{

	}

	void LightCullingComputeSystem::Init()
	{
		Q_RENDER_INFO("INITIALIZING LIGHT CULLING (COMPUTE) RENDER SYSTEM");
	...
	void LightCullingComputeSystem::Render()
	{
		//Just incase someone uses render instead of dispatch
		Dispatch();
	}

	void LightCullingComputeSystem::Update()
	{

	}

	void LightCullingComputeSystem::SetUpData()
	{

	}

	void LightCullingComputeSystem::Dispatch()
	{
	...
	void LightCullingComputeSystem::Bind()
	{

	}

	void LightCullingComputeSystem::Unbind()
	{

	}

	void LightCullingComputeSystem::DebugDraw()
	{

	}

	void LightCullingComputeSystem::Resize(int width, int height)
	{
		//Not applicable (Compute)
	}

	void LightCullingComputeSystem::UpdateCamera(Ref<QRender::EditorCamera> cullingCamera)
	{
		m_cullingCamera = cullingCamera;
	}

	void LightCullingComputeSystem::SetRenderBucket(RenderBucket* inRenderBucket)
	{
