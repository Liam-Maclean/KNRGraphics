...
namespace KNR
{
	...
	{
		return new DirectX11Framebuffer(spec);
	}
	...
	void DirectX11Framebuffer::Bind(CommandBuffer* commandList)
	{
		
	}

	void DirectX11Framebuffer::Unbind(CommandBuffer* commandList)
	{
	...
	void DirectX11Framebuffer::ClearAttachment(uint32_t attachmentIndex, int value)
	{
