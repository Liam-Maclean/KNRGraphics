...
namespace KNR
{
	DirectX12Pipeline::DirectX12Pipeline(const PipelineCreateInfo& desc)
	{
	...
	void DirectX12Pipeline::Bind(DirectX12CommandBuffer* commandList)
	{
		//bind compute
		if (m_pipelineCreateInfo.computeShader.pShaderBytecode != nullptr)
		{
	...
	void DirectX12Pipeline::Unbind(DirectX12CommandBuffer* commandList)
	{
