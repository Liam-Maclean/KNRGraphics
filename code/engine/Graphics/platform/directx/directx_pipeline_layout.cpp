...
namespace KNR
{
	...
	DirectXPipelineLayout::DirectXPipelineLayout()
	{
	...
	void DirectXPipelineLayout::AddDescriptorTable(const std::string& name, uint32_t registerSlot, int32_t numDescriptors, uint32_t registerSpace, DescriptorTableType tableType, ShaderVisibility visibility)
	{
	...
	void DirectXPipelineLayout::AddRootConstant(const std::string& name, uint32_t numOfValues, uint32_t registerSlot, uint32_t registerSpace, ShaderVisibility visibility)
	{
		CD3DX12_ROOT_PARAMETER rootParameter = {};
	...
	void DirectXPipelineLayout::AddShaderResourceView(const std::string& name, uint32_t registerSlot, ShaderVisibility visibility)
	{
		CD3DX12_ROOT_PARAMETER rootParameter = {};
	...
	void DirectXPipelineLayout::AddConstantResourceView(const std::string& name, uint32_t registerSlot, ShaderVisibility visibility)
	{
		CD3DX12_ROOT_PARAMETER rootParameter = {};
	...
	void DirectXPipelineLayout::AddUnorderedAccessView(const std::string& name, uint32_t registerSlot, ShaderVisibility visibility)
	{
		CD3DX12_ROOT_PARAMETER rootParameter = {};
	...
	void DirectXPipelineLayout::AddSampler(const std::string& name, uint32_t registerSlot, SamplerType samplerType)
	{
	...
	void DirectXPipelineLayout::CreateRootSignature()
	{
