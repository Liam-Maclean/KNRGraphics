...
namespace QRender
{
	...
	HRESULT DirectXHeap::Create(ID3D12Device* device, D3D12_DESCRIPTOR_HEAP_TYPE type, UINT numDescriptors, bool bShaderVisible)
	{
		HRESULT hr;
	...
	UINT64 DirectXHeap::MakeOffsetted(UINT64 ptr, UINT index)
	{
		UINT64 offsetted;
	...
	D3D12_CPU_DESCRIPTOR_HANDLE DirectXHeap::handleCPU(UINT index)
	{
	...
	D3D12_GPU_DESCRIPTOR_HANDLE DirectXHeap::handleGPU(UINT index)
	{
