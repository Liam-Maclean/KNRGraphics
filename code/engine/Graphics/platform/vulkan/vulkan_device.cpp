...
VkCommandPool VulkanDevice::createCommandPool()
{
	...
	Qualia::Vulkan::Utility::VulkanErrorCheck(vkCreateCommandPool(GetVulkanDevice(), &cmdPoolInfo, nullptr, &cmdPool));
	return cmdPool;
}


//creates an instance of vulkan api
void VulkanDevice::_InitInstance()
{
	...
	Qualia::Vulkan::Utility::VulkanErrorCheck(vkCreateInstance(&instance_create_info, nullptr, &_instance));
}

//Destroy instance of vulkan api
void VulkanDevice::_DeInitInstance()
{
...
/*
void VulkanDevice::_CreateBuffer(VkDeviceSize size, VkBufferUsageFlags usage, VkMemoryPropertyFlags properties, vk::wrappers::Buffer* buffer, void* data)
{
	...
	Qualia::Vulkan::Utility::VulkanErrorCheck(vkCreateBuffer(_device, &buffer_create_info, nullptr, &buffer->buffer));
	...
	Qualia::Vulkan::Utility::VulkanErrorCheck(vkAllocateMemory(_device, &memory_allocate_info, nullptr, &buffer->memory));

	// If a pointer to the buffer data has been passed, map the buffer and copy over the data
	if (data != nullptr)
	{
		Qualia::Vulkan::Utility::VulkanErrorCheck(buffer->map());
...
bool VulkanDevice::_CheckDeviceExtentionSupport(VkPhysicalDevice device)
{
...
void VulkanDevice::_InitDevice()
{
	...
	Qualia::Vulkan::Utility::VulkanErrorCheck(vkCreateDevice(_gpu, &device_create_info, nullptr, &_device));
...
void VulkanDevice::_DeInitDevice()
{
...
uint32_t VulkanDevice::_GetMemoryType(uint32_t memTypeBits, VkMemoryPropertyFlags propertyFlags, VkBool32* memTypeFound)
{
...
void VulkanDevice::_DeInitDebug()
{
